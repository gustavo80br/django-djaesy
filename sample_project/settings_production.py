...
ALLOWED_HOSTS = ['app.djaesy.com.br']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'djaesy',
        'USER': 'dbuser',
        'PASSWORD': 'ReOubB1jypvwuUIQtgaNRHmsQQYHKt43',
...
MONGO_DATABASES = {
    'mongoi3t': {
        ...
        'database': 'djaesy',
        'user': 'djaesyapis',
        'password': 'E29dbi8WImHetjcaAAk65L3z8VxptohXfhYepV0X'
    }
}
...
EMAIL_BASE_URL = 'https://app.djaesy.com.br'
