...
class AppPanelConfig(AppConfig):
    ...
    def ready(self):
        ...
        settings.LOGOUT_REDIRECT_URL = getattr(settings, 'LOGOUT_REDIRECT_URL') or '/app/'
        settings.LOGIN_REDIRECT_URL = getattr(settings, 'LOGIN_REDIRECT_URL') or '/app/'
        ...
        settings.LEAFLET_CONFIG = {
            ...
            'PLUGINS': {
                'prugin': {
                    'css': ['https://unpkg.com/@geoman-io/leaflet-geoman-free@latest/dist/leaflet-geoman.css',
